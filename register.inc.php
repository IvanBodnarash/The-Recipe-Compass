<div class="register-block-wrapper">
    ...
    <form class="register-form" action="index.php" method="post">
        <div class="register-form-wrapper">
            ...
            <input type="text" name="userid" id="inputReg" require>
        
            <span id="loginTxt">Password</span>
            <input type="password" name="password" id="inputReg" require>
        
            <span id="loginTxt">Confirm Password</span>
            <input type="password" name="password2" id="inputReg" require>
        
            <span id="loginTxt">Full name</span>
            <input type="text" name="fullname" id="inputReg" require>
        
            <span id="loginTxt">E-mail address</span>
            <input type="text" name="email" id="inputReg" require>
